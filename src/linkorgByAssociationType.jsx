  ...
  const cleanData = (responce) => {
    ...
    resp.map((dailysplit) => {
      for (var i in Object.entries(
        dailysplit["followers_split"]["followerCountsByAssociationType"]
      )) {
        for (var j in dailysplit["followers_split"][
          "followerCountsByAssociationType"
        ][i]) {
          if (j === "associationType") {
            sentimentObject["associationType"] =
              dailysplit["followers_split"]["followerCountsByAssociationType"][
                i
              ]["associationType"];
        ...
        console.log("sentiif data:", sentimentObject);
  ...
  return (
    <>
      {data && (
        <>
          <DownloadExcel
            title="followerCountsByAssociationType"
            data={data}
            fileName="followerCountsByAssociationType"
            buttonLabel="followerCountsByAssociationType"
