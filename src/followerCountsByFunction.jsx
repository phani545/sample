  ...
  const cleanData = (responce) => {
    ...
    resp.map((dailysplit) => {
      for (var i in Object.entries(
        dailysplit["followers_split"]["followerCountsByFunction"]
      )) {
        for (var j in dailysplit["followers_split"]["followerCountsByFunction"][
          i
        ]) {
          if (j === "functionText") {
            sentimentObject["industryText"] =
              dailysplit["followers_split"]["followerCountsByFunction"][i][
                "functionText"
              ];
        ...
        //console.log("followerCountsByFunction", sentimentObject);
  ...
  return (
    <>
      {data && (
        <>
          <DownloadExcel
            title="followerCountsByFunction"
            data={data}
            fileName="followerCountsByFunction"
            buttonLabel="followerCountsByFunction"
...
export default CountsByFunction;
