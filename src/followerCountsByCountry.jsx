  ...
  const cleanData = (responce) => {
    ...
    resp.map((dailysplit) => {
      for (var i in Object.entries(
        dailysplit["followers_split"]["followerCountsByCountry"]
      )) {
        for (var j in dailysplit["followers_split"]["followerCountsByCountry"][
          i
        ]) {
          if (j === "countryText") {
            sentimentObject["industryText"] =
              dailysplit["followers_split"]["followerCountsByCountry"][i][
                "countryText"
              ];
        ...
        //console.log("followerCountsByCountry", sentimentObject);
  ...
  return (
    <>
      {data && (
        <>
          <DownloadExcel
            title="followerCountsByCountry"
            data={data}
            fileName="followerCountsByCountry"
            buttonLabel="followerCountsByCountry"
